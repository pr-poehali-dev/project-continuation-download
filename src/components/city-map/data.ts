...
export const CONNECTIONS = [
  ...
  ['function_factory', 'engineers_bay'],
  ['data_docks', 'syntax_slums'],
  ['data_docks', 'server_farm'],
  ['syntax_colosseum', 'archive_arena'],
  // outer ring → bosses
